...
public class MataKuliah extends Frame {
    ...
    public MataKuliah() {
        ...
        btnTampilkan = new Button("Tampilkan Nilai Mata Kuliah");
        add(btnTampilkan);
        btnTampilkan.setBounds(90, 550, 170, 30);
